...
import it.giovanni.next.databinding.FragmentEggTimerBinding
...
class EggTimerFragment : Fragment() {
    ...
    /*
    Change importance
    Once the channel is created, you, the developer, cannot change the importance of the channel.
    This is because the channel is now exposed to the user and they have full control over the
